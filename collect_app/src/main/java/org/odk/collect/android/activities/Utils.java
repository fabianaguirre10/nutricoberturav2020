...
class Utils {
    ...
    static void sendNotification(Context context, String notificationDetails) {
        ...
        Intent notificationIntent = new Intent(context, configuracion.class);
        ...
        stackBuilder.addParentStack(configuracion.class);
    ...
    private static String getLocationResultText(Context context, List<Location> locations) {
        ...
        envioinformacion objenvio = new envioinformacion();
        if(location !=null) {
            objenvio.setGeolatitude(String.valueOf(location.getLatitude()));
            objenvio.setGeoLength(String.valueOf(location.getLongitude()));
            objenvio.setGeoAccuracy(String.valueOf(location.getAccuracy()));
            objenvio.setNameAccount(objconfiguracionSession.getCnf_AccountNombre());
            objenvio.setNamecampaign(objconfiguracionSession.getCnf_CampaniaNombre());
            objenvio.setIdDevice(objconfiguracionSession.getCnf_imei());
            objenvio.setBatteryStatus(objconfiguracionSession.getCnf_batteryStatus());

            IntentFilter ifilter = new IntentFilter(Intent.ACTION_BATTERY_CHANGED);

        }
            String[] myTaskParams = {objenvio.getGeolatitude(), objenvio.getGeoLength(), objenvio.getGeoAccuracy(),
                    objenvio.getNameAccount(), objenvio.getNamecampaign(), objenvio.getIdDevice(), objenvio.getBatteryStatus()};
            PostJSONWithHttpURLConnection fetchJsonTask = new PostJSONWithHttpURLConnection();
